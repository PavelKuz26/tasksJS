...
colorSelector.addEventListener('change', (e) =>{
    ...
    const itemsBlocks = blocksContainer.querySelectorAll('.item-blocks');

    changed = !changed;

    for(let i = 0; i < itemsBlocks.length; i++){
        const currentBlock = itemsBlocks[i];
